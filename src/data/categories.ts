...
/**
 * SALAAR'S HOME – Product categories.
 * Edit the copy here to change descriptions, materials, etc.
 * The `slug` must match the `category` value of your products in products.ts.
 */
...
export const CATEGORIES: CategoryInfo[] = [
  {
    ...
    dimensions:
      "Sets are made in full, queen and king sizes – exact dimensions vary by model.",
  ...
  },
  {
    ...
    material:
      "Solid wood frame with premium laminate or lacquer finishes and soft-close hardware.",
  ...
  },
  {
    ...
    material:
      "Solid wood tops with durable lacquer finish; metal or wood legs depending on design.",
  ...
  },
  {
    ...
    material:
      "Solid wood construction with hand-finished lacquer and premium mirror glass.",
